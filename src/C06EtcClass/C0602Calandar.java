...
public class C0602Calandar {
    public static void main(String[] args) {
//          java.util 패키지의 Calandar클래스
...
//        System.out.println(birthDay.getDayOfMonth());
        ...
        LocalDateTime birthDayTime = LocalDateTime.of(2000,11,12,13,14);
        ...
        System.out.println(birthDayTime.get(ChronoField.AMPM_OF_DAY)); //0:오전 1:오후
